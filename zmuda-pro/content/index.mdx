...
* **Kubernetes Management**: Deploy, secure, and maintain Kubernetes clusters in Azure (AKS) and AWS (EKS),
  ensuring reliable and scalable infrastructure for development teams.
* **Kubernetes Platform Development**: Actively contribute to the development and optimization of our Kubernetes platform,
  enhancing capabilities and reliability for internal teams.
...
* **Security & Architecture Advisory**: Proactively identify security vulnerabilities in products and infrastructure,
  provide actionable remediation strategies, contribute to architecture decisions, and mentor teams on best practices for maintaining secure
  environments.
