...
At my first KubeCon, I decided to try capture the flag event. The organizer said it is encouraged to team up,
so our table of 3 joined forces. We exploited unprotected OCI registry, found out what compromised pods are doing by checking
[tetragon](https://tetragon.io/) logs and lastly opening a reverse shell from an unprotected website
we managed to finish in the top 8 out of 138 participants!

The challenges is nicely described [here](https://www.skybound.link/2025/04/kubecon-eu-2025-ctf-writeup/).
And you can also see **Hossem**, **TOLF** and **adzik** (me) on the screenshot at the end.
